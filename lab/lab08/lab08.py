...
def duplicate_link(link, val):
    ...
    if link.first == val:
        ...
        # link = Link(val, link) # why doesnt this work?? - does not modify in place
        duplicate_link(link.rest.rest, val)
    else:
        duplicate_link(link.rest, val) 

    # while x.first != Link.empty:
    #     if x.first == val:
    #         link = Link(val, link)
    #         x = x.rest.rest
    #     else:
...
def cumulative_mul(t):
    ...
    if t.is_leaf():
        ...
        for branch in t.branches: 
            ...
            # so flipping elegant holy smokes... the class takes care of the objects.. u just access with dots  
